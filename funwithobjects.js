...
//and an array full or numbers. Your job is to write a function named finder that will get a random number, 
...
*/
  ...
  //Code Here
var removeItem = function(myGroceryList, bad) {
  var i = myGroceryList.indexOf(bad)
  if (i !== -1)
    myGroceryList.splice(i, 1)
  return myGroceryList;
}

var addItem = function(myGroceryList, good) {
  myGroceryList.push(good);
  return myGroceryList;
}
...
//Write a function that is given arr1 and arr2 is it's only arguments. Return the array which is longest.
  ...
  //Code Here
var compareLen = function(arr1, arr2) {
